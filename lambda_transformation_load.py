...
def lambda_handler(event, context):
    ...
    for data in spotify_data:
        ...
        album_df['release_date']=pd.to_datetime(album_df['release_date'],errors='ignore')
        song_df["song_added"]=pd.to_datetime(song_df["song_added"],errors="ignore")
        
        songs_key = "transformed_data/song/songs_transformed_" + str(datetime.now()) + ".csv"
